...
- comeback → тёплое признание возвращения после серии срывов. «Вернулся в строй — вот это и считается».
- fresh_start → «день первый, погнали». Чистый старт, без оглядки назад.
